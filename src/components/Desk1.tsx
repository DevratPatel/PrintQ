...
export const Desk1 = () => {
  ...
  const serving = getServingForDesk("desk1");
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <GlassCard className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-6">Desk 1</h2>
            ...
            <div>
              ...
              {serving ? (
                ...
                >
                  ...
                  <button
                    onClick={() => completeServingForDesk("desk1")}
